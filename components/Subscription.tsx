...
export default function PricingSlider() {
  ...
  return (
    <div className="w-[327px] sm:w-[540px] bg-[#FFFFFF] rounded-lg shadow-lg p-6 sm:px-12">
      <div className="space-y-8">
        <div className="text-center">
          <div className="text-sm sm:text-base text-[#848EAD] font-semibold mb-6 sm:flex sm:flex-row sm:justify-between sm:items-center ">
            ...
            ${price}{" "}
            <span className="text-base text-[#848EAD] font-semibold mt-6">/month</span>
          </div>
          </div>
          <div className="relative w-full">
            ...
            <div
              ...
              style={{
                left: `calc(${((sliderValue - 100) / (2000 - 100)) * 100}% - 12px)`,
          ...
          <div className=" sm:hidden mt-8 text-3xl font-bold text-[#293356]">
            ${price}{" "}
            <span className="text-sm text-[#848EAD] font-semibold">/ month</span>
          </div>
        </div>

        <div className="flex items-center justify-center ">
          <span className="text-sm text-[#848EAD] font-normal mx-1">Monthly Billing</span>
          ...
          <span className="text-sm text-[#848EAD] font-normal flex flex-row mx-1">
            Yearly Billing
            <div className="text-orange text-xs font-bold ml-1 p-2 h-[20px] bg-[#FEEDE8] rounded-[10px] flex justify-center items-center align-middle">
          ...
          <div className="mt-6">
                <div className="flex flex-row justify-center text-xs my-2"><div className="pt-[6px] mr-4"><img className="h-[7px] w-[10px]" src="/img/icon-check.svg" alt="" /></div><p className="text-lightgrey text-bold">Unlimited Websites</p></div>
                <div className="flex flex-row justify-center text-xs my-2"><div className="pt-[6px] mr-4"><img className="h-[7px] w-[10px]" src="/img/icon-check.svg" alt="" /></div><p className="text-lightgrey text-bold">100%d ata ownership</p></div>
                <div className="flex flex-row justify-center text-xs my-2"><div className="pt-[6px] mr-4"><img className="h-[7px] w-[10px]" src="/img/icon-check.svg" alt="" /></div><p className="text-lightgrey text-bold">Email reports</p></div>
